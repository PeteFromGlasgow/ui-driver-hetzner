  ...
  exports.default = Ember.Component.extend(_nodeDriver.default, {
    ...
    actions: {
      getData: function getData() {
        var apiKey, baseHetznerData, selectedServerLocation, selectedServerType, imageChoices, networkChoices, _ref, _ref2, locations, serverTypes, sshKeys, firewalls, placementGroups, serverLocation, regionNetworks, serverType;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                baseHetznerData = Promise.all([(0, _hetzner.apiRequest)(apiKey, '/v1/locations'), (0, _hetzner.apiRequest)(apiKey, '/v1/server_types'), (0, _hetzner.apiRequest)(apiKey, '/v1/ssh_keys'), (0, _hetzner.apiRequest)(apiKey, '/v1/firewalls'), (0, _hetzner.apiRequest)(apiKey, '/v1/placement_groups')]);
                ...
                networkChoices = [];
                _context.next = 10;
                return regeneratorRuntime.awrap(baseHetznerData);
              ...
              case 10:
                ...
                serverLocation = locations.locations.filter(function (i) {
                  return i.name === selectedServerLocation;
                })[0];
                _context.next = 21;
                return regeneratorRuntime.awrap((0, _hetzner.getNetworksByZone)(apiKey, serverLocation.network_zone));
              ...
              case 21:
                ...
                regionNetworks = _context.sent.map(_context.t0);
              ...
              case 24:
                ...
                serverType = serverTypes.server_types.filter(function (i) {
              ...
              case 28:
                ...
                imageChoices = _context.sent.images.sort(_context.t1);
              ...
              case 33:
                ...
                this.setProperties({
                  errors: ['Error received from Hetzner Cloud: ' + _context.t2.message],
                  gettingData: false
                });
      ...
      updateServerLocation: function updateServerLocation(select) {
        var apiKey, options, regionChoices, regionDetails, regionNetworks;
      ...
      updateImage: function updateImage(select) {
        ...
        this.set('model.hetznerConfig.image', imageChoice.name);
      },
